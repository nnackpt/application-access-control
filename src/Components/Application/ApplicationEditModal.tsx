  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const submitData = {
        ...
        active: form.active,
        createD_BY: editData.createD_BY || editData.createdBy || 'system',
        createD_DATETIME: editData.createD_DATETIME || editData.createdDatetime || '',
        updateD_BY: form.updatedBy || 'system',
